...
function LoginForm() {
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-xl relative overflow-hidden">
      {/* Decorative top bar */}
      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-13 py-3.5 text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                placeholder="••••••••"
                required
                autoComplete="off"
              />
              <button
                ...
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 touch-manipulation"
              >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white py-3.5 rounded-xl font-semibold text-base hover:bg-blue-700 active:bg-blue-800 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors touch-manipulation"
          >
            {loading ? (
      ...
      <div className="mt-8 pt-8 border-t border-gray-100 relative z-10">
        <p className="text-xs text-gray-400 text-center mb-4 uppercase tracking-wide">Fonctionnalités</p>
...
function FeatureItem({ icon, label, desc }: { icon: React.ReactNode; label: string; desc: string }) {
  return (
    <div className="text-center p-3 bg-gray-50 rounded-xl">
      <div className="mx-auto mb-2 p-2 bg-blue-50 text-blue-600 rounded-lg">{icon}</div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Gestion de stock simple & efficace</p>
        </div>
